...
Below is a quick primer on some of those methods. The entire list of methods is: `spread()`, `iter()`, `sometimes()`, `mix()`, `drift()`, `slices()`, `subrange()`, `dirsamp()`, `slices2d()`, `columns2d()`, `seq()`

Please see the README for more details on each method.
