...
app.post('/update', (req, res) => {
  update_patterns = JSON.parse(req.body.facet_patterns);
  res.sendStatus(200);
});
...
function tick() {
  if ( transport_on !== false) {
    ...
    if ( current_step >= steps ) {
      ...
      // get the set of patterns generated by the patterns server during the last loop
      facet_patterns = update_patterns;
